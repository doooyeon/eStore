	...
	<div class="container">
		<div class="jumbotron">
			<div class="container">
				...
				<p>All the selected products in your shooping cart</p>
			</div>
		</div>
				...
				<table class="table table-hover">
					...
					<tr ng-repeat="item in cart.cartItems">
						...
						<td><a href="#" class="label label-danger" ng-click="removeFromCart(item.product.id)" >
							...
							<a href="#" class="label label-danger" ng-click="addQuantity(item.product.id)" >
							<span class="glyphicon glyphicon-plus"></span>plus</a>
							<a href="#" class="label label-danger" ng-click="subQuantity(item.product.id)" >
							<span class="glyphicon glyphicon-minus"></span>minus</a>
						</td>
					</tr>
